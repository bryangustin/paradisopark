                            ...
                            <div class="hidden h-full lg:flex">
                                ...
                                <PopoverGroup class="px-4 bottom-0 inset-x-0">
                                    <div class="h-full flex justify-center space-x-8">
                                        ...
                                        <router-link v-for="contact in navigation.contact" :key="contact.name" to="#contact" @click="scrollMeTo('contact')" class="transition_navbar flex items-center font-light text-black hover:text-black">{{ contact.name }}</router-link>
